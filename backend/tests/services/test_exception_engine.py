...
from app.db.facts import InventorySnapshot, PurchaseOrder, SalesOrder, SalesOrderLine, Shipment
...
def _purchase_order(
    session: Session, *, expected_delivery_date: date, status: PurchaseOrderStatus
) -> PurchaseOrder:
    po = PurchaseOrder(
